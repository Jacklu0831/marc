...
def run_trial(num_train=100, d=20, r=100, num_train_steps=5000, lr=5e-3, batch_size=10):
    ...
    ground_truth_net = create_ground_truth_net(d, r).to(device)
