# python make_sbatch.py --ngpu 2 --time 48 --bash_files bash_commands/0127_multiprogram/0127_5_multiprogram_debug5.sh
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder0129_multiprogram/train.py \
    ...
    --eval_batch_size 2 \
    --tag 0127_multiprogram_notrainoriginal \
    --no_train_original \
    --wandb

# Submitted batch job 56668850