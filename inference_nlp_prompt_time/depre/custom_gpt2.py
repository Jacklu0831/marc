...
class MyGPT2SdpaAttention(GPT2Attention):
    """
...
GPT2_ATTENTION_CLASSES = {"sdpa": MyGPT2SdpaAttention} # only keep sdpa for now
...
class MyGPT2LMHeadModel(GPT2PreTrainedModel, GenerationMixin):
