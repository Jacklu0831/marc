...
from transformers.generation.utils import GenerationMixin, GenerateOutput, GenerateNonBeamOutput
        ...
        **kwargs,
        ...
        if not self.config.is_encoder_decoder:
            ...
            if inputs_embeds is not None:
                model_inputs[input_ids_key] = None
                model_inputs["inputs_embeds"] = inputs_embeds[:, cache_position, :].clone(memory_format=torch.contiguous_format)
            else:
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            if is_prefill:
                ...
                outputs = model_forward(**model_inputs, return_dict=True, is_prefill=is_prefill) # JACK
...
class MyLlamaForCausalLM(LlamaForCausalLM, MyGenerationMixin):

    def __init__(self, config):
        super().__init__(config)
        self.model = MyLlamaModel(config) # JACK
        self.vocab_size = config.vocab_size
