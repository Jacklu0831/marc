...
# each data corresponds to a list of augmented tasks (up to 250 ish)
# each task in the format of:
# {
#     'input':
#         [
#             {'role': 'system', 'content': 'Figure out the underlying transformation in the following examples and apply it to the test case. Here are some examples from this transformation, your answer must follow the format.\nThe input-output grids are provided as python arrays:\n[[9 7 7 9]\n [7 2 2 7]] -> [[9 7 9 7 9 7 7 9 7 9 7 9]\n [7 2 7 2 7 2 2 7 2 7 2 7]\n [7 9 7 9 7 9 9 7 9 7 9 7]\n [2 7 2 7 2 7 7 2 7 2 7 2]\n [9 7 9 7 9 7 7 9 7 9 7 9]\n [7 2 7 2 7 2 2 7 2 7 2 7]]#\n'},
#             {'role': 'user', 'content': '[[6 8 8 6]\n [2 5 5 2]] -> '}
#         ],
#     'output':
#         {'role': 'assistant',
#          'content': '[[6 8 6 8 6 8 8 6 8 6 8 6]\n [2 5 2 5 2 5 5 2 5 2 5 2]\n [8 6 8 6 8 6 6 8 6 8 6 8]\n [5 2 5 2 5 2 2 5 2 5 2 5]\n [6 8 6 8 6 8 8 6 8 6 8 6]\n [2 5 2 5 2 5 5 2 5 2 5 2]]#'},
#     'total_tokens': 399
# }
