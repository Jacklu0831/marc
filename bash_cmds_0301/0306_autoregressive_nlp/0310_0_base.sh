# python make_sbatch.py --ngpu 2 --time 24 --gb 64 --bash_files bash_commands/0306_autoregressive_nlp/0310_0_base.sh --burst
...
# failed
# Submitted batch job 36659
# Submitted batch job 36686
# Submitted batch job 36687