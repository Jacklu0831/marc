# python make_sbatch.py --ngpu 1 --time 18 --rtx8000 --single --bash_files bash_cmds/0401_nlp/0425_smallgridsearchmoreiter/lr1e-3_droppower_tokendrop0.01_lambda1e-2.sh
