# python make_sbatch.py --ngpu 1 --time 18 --rtx8000 --single --bash_files bash_cmds/0401_nlp/0425_smallgridsearchmoreiter/lr5e-3_droptrain_tokendrop0.01_lambda0.sh
