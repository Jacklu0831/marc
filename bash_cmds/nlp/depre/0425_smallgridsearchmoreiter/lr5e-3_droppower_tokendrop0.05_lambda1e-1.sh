# python make_sbatch.py --ngpu 1 --time 18 --rtx8000 --single --bash_files bash_cmds/0401_nlp/0425_smallgridsearchmoreiter/lr5e-3_droppower_tokendrop0.05_lambda1e-1.sh
