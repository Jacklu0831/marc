# python make_sbatch.py --ngpu 1 --time 12 --rtx8000 --bash_files bash_cmds/nlp/randommlpinit/prefixtoken_lr1e-3.sh
...
# Submitted batch job 60749450
# Submitted batch job 60749451
# Submitted batch job 60749452
# Submitted batch job 60749453
