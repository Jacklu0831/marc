# python make_sbatch.py --ngpu 1 --time 12 --rtx8000 --bash_files bash_cmds/nlp/randommlpinit/prompttoken_lr3e-3.sh
...
# nlp prompt150 lr3e-3 droptrain tokendrop0.1 random evalseed100
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 inference_nlp_prompt_time/test_time_evaluate.py \
    --tag nlp_prompt150_lr3e-3_droptrain_tokendrop0.1_random_evalseed100 \
    --weight_dir nlp_pretrained \
    --weight_epoch 0 \
    --gs_epochs 150 \
    --gs_lr 3e-3 \
...
# Submitted batch job 60749488
# Submitted batch job 60749489
# Submitted batch job 60749490
# Submitted batch job 60749491