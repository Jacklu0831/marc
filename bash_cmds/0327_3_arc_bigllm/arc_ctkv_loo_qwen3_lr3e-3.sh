# ARC CT-KV+LOO with off-the-shelf Qwen3-14B (non-thinking mode) (4-bit quantized)
...
# makesbatch --time 6 --ngpu 1 --gb 64 --no_singularity --bash_file bash_cmds/0327_3_arc_bigllm/arc_ctkv_loo_qwen3_lr3e-3.sh

# arc_bigllm_ctkv_loo_qwen3_14b_part2
.venv/bin/accelerate launch --mixed_precision bf16 \
    inference_arc_bigllm/test_time_evaluate.py \
    --tag arc_bigllm_ctkv_loo_qwen3_14b_part2 \
...
# arc_bigllm_ctkv_loo_qwen3_14b_part4
.venv/bin/accelerate launch --mixed_precision bf16 \
    inference_arc_bigllm/test_time_evaluate.py \
    --tag arc_bigllm_ctkv_loo_qwen3_14b_part4 \
    --model_name qwen3_14b --untrainable_nbit 4 --flash_attn --gradient_checkpointing \
    --select_tasks_path data/task_info_part4.csv \
    --no_bos --seed 42 \
    --gs_epochs 200 --gs_lr 3e-3 --gs_dropout train --gs_token_dropout 0.1 --gs_float16

#! Submitted batch job 5071396 -> 36_cds -- arc_bigllm_ctkv_loo_qwen3_14b_part2
#! Submitted batch job 5071398 -> 36_cds -- arc_bigllm_ctkv_loo_qwen3_14b_part4