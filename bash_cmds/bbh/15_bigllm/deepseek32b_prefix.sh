...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 inference_bbh_bigllm/test_time_evaluate.py \
    --tag bbh_deepseek32b_prefixntoken15_lr3e-3_seed42 \
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 inference_bbh_bigllm/test_time_evaluate.py \
    --tag bbh_deepseek32b_prefixntoken20_lr3e-3_seed42 \
    --model_name deepseek32b \
    --untrainable_nbit 4 \
    --batch_size 4 \
    --gs_epochs 20 \
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 inference_bbh_bigllm/test_time_evaluate.py \
    --tag bbh_deepseek32b_prefixntoken25_lr3e-3_seed42 \
    --model_name deepseek32b \
    --untrainable_nbit 4 \
    --batch_size 4 \
    --gs_epochs 25 \
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 inference_bbh_bigllm/test_time_evaluate.py \
    --tag bbh_deepseek32b_prefixntoken30_lr3e-3_seed42 \
    --model_name deepseek32b \
    --untrainable_nbit 4 \
    --batch_size 4 \
    --gs_epochs 30 \
