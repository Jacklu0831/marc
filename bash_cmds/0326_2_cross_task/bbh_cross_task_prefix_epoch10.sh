...
# makesbatch --time 6 --ngpu 1 --gb 64 --l40s --single --bash_file bash_cmds/0326_2_cross_task/bbh_cross_task_prefix_epoch10.sh

# --- logical_deduction family: 3x3 matrix ---

# ct_bbh_cross_prefix_logdeduc_src_three_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_logdeduc_src_three_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
...
# ct_bbh_cross_prefix_logdeduc_src_five_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_logdeduc_src_five_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
    --random_kv token --random_kv_ntokens 32 \
...
# ct_bbh_cross_prefix_logdeduc_src_seven_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_logdeduc_src_seven_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
    --random_kv token --random_kv_ntokens 32 \
...
# ct_bbh_cross_prefix_tracking_src_three_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_tracking_src_three_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
    --random_kv token --random_kv_ntokens 32 \
...
# ct_bbh_cross_prefix_tracking_src_five_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_tracking_src_five_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
    --random_kv token --random_kv_ntokens 32 \
...
# ct_bbh_cross_prefix_tracking_src_seven_ep10_seed42
.venv/bin/accelerate launch --mixed_precision bf16 inference_bbh/test_time_evaluate.py \
    --tag ct_bbh_cross_prefix_tracking_src_seven_ep10_seed42 \
    --seed 42 --max_seq_len 4096 \
    --gs_epochs 10 --gs_lr 3e-3 --gs_batch_size 2 --gs_dropout none \
    --random_kv token --random_kv_ntokens 32 \
...
#! Submitted batch job 5071762 -> 36_mren -- bbh_cross_task_prefix_epoch10
