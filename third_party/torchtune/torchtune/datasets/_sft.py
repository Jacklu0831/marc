...
class SFTDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        change_dataset_key: bool = False,
        **load_dataset_kwargs: Dict[str, Any],
    ) -> None:
        self._message_transform = message_transform
        self._model_transform = model_transform
        self._unmask_outputs = unmask_outputs
        self._change_dataset_key = change_dataset_key
    ...
    def _prepare_sample(self, sample: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        # <torchtune.models.llama3._tokenizer.Llama3Tokenizer object at 0x15186a0506d0>
        tokenized_dict = self._model_transform(transformed_sample, unmask_outputs=self._unmask_outputs) # dict tokens and mask list
        ...
        if self._change_dataset_key:
            tokenized_dict['input_ids'] = tokenized_dict.pop("tokens")
