# python make_sbatch.py --time 48 --bash_files bash_commands/1129_llama8b_finetuned_prefix_tuning_lr5e-3/1129_1_llama8b_inference_prefix_tuning_ntoken3_lr5e-3.sh
