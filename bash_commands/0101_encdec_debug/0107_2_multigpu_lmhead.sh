# python make_sbatch.py --ngpu 2 --time 48 --bash_files bash_commands/0101_encdec_debug/0107_2_multigpu_lmhead.sh

# debug invar0.0 multigpu lmhead
accelerate launch --mixed_precision bf16 encoder_decoder/train.py \
    --tag debug_invar0.0_multigpu_lmhead \
...
# full invar0.0 multigpu lmhead
accelerate launch --mixed_precision bf16 encoder_decoder/train.py \
    --tag full_invar0.0_multigpu_lmhead \
