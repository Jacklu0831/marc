# python make_sbatch.py --ngpu 2 --time 48 --bash_files bash_commands/0101_encdec_debug/0106_1_multigpu.sh
...
# port error
# Submitted batch job 55609378
# Submitted batch job 55609379

# Submitted batch job 55609488
# Submitted batch job 55609489