# python make_sbatch.py --ngpu 2 --time 48 --bash_files bash_commands/0317_autoregressive/0317_4_programloss.sh
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/train.py \
    ...
    --no_bos \
    --token_weighted_loss \
    --tag 0317_arlongcache_programloss0.1random \
    --program_type random \
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/train.py \
    ...
    --no_bos \
    --token_weighted_loss \
    --tag 0317_arlongcache_programloss0.3random \
    --program_type random \
...
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/train.py \
    ...
    --no_bos \
    --token_weighted_loss \
    --tag 0317_arlongcache_programloss1.0random \
    --program_type random \
