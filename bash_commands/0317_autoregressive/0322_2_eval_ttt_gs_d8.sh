# for gs0, 1, 5, 25
# python make_sbatch.py --ngpu 1 --time 3 --bash_files bash_commands/0317_autoregressive/0322_2_eval_ttt_gs_d8.sh

# for more
# python make_sbatch.py --ngpu 1 --time 7 --bash_files bash_commands/0317_autoregressive/0322_2_eval_ttt_gs_d8.sh


# gs1lr1e-3 0317_arlongcache_base augd8epoch10
...
# gs5lr1e-3 0317_arlongcache_base augd8epoch10
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/evaluate.py \
    --no_bos \
...
# gs25lr1e-3 0317_arlongcache_base augd8epoch10
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/evaluate.py \
    --no_bos \
...
# gs100lr1e-3 0317_arlongcache_base augd8epoch10
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/evaluate.py \
    --no_bos \
...
# gs250lr1e-3 0317_arlongcache_base augd8epoch10
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_autoregressive_longcontext_caching/evaluate.py \
    --no_bos \
