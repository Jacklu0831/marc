...
# voting 0317_noprogram_base augd8epoch6 leavens1
accelerate launch --main_process_port $MASTER_PORT --mixed_precision bf16 encoder_decoder_noprogram/evaluate.py \
    --no_bos \
...
# Submitted batch job 58849369
# Submitted batch job 58849370
# Submitted batch job 58849371
# Submitted batch job 58849372
# Submitted batch job 58849373
# Submitted batch job 58849374