# python make_sbatch.py --time 48 --bash_files bash_commands/1201_llama8b_finetuned_prefix_tuning_lr5e-3/1201_2_llama8b_inference_prefix_tuning_ntoken5_lr5e-3.sh
...
python predict_prefix_tuning.py \
    ...
    --pt_checkpoints_folder train_outputs/1129_0_llama8b_finetuned_ttt_prefix_tuning_lr5e-3_ntoken5 \
