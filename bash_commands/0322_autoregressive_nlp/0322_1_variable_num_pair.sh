# python make_sbatch.py --ngpu 1 --time 48 --bash_files bash_commands/0322_autoregressive_nlp/0322_1_variable_num_pair.sh
...
# Submitted batch job 58652026
# Submitted batch job 58652027
# Submitted batch job 58652028