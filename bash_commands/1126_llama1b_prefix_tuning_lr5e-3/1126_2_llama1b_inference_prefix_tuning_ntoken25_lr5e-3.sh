# python make_sbatch.py --time 48 --bash_files bash_commands/1126_prefix_tuning_predict_lr5e-3/1126_2_llama1b_inference_prefix_tuning_ntoken25_lr5e-3.sh
...
# Submitted batch job 54060233
# Submitted batch job 54060234
