...
def main():
    ...
    if args.debug:
        args.tag = 'test'
        args.wandb = False
        args.train_data_dir = './data/re-arc/train_data_debug/tasks'
        args.eval_train_dir = './data/re-arc/arc_original_debug/training'
        args.eval_eval_dir = './data/re-arc/arc_original_debug/evaluation'
        args.num_epochs = 3
